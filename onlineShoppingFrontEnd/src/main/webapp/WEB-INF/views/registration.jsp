	...
	$(document).ready(function(){
		$('#form1').validate({
			rules:{
				...
				"user.password":{required:true,minlength:7,maxlength:10},
				...
				"shippingAddress.apartmentnumber":{required:true},
				"shippingAddress.streetname":{required:true},
				"shippingAddress.city":{required:true},
				"shippingAddress.state":{required:true},
				"shippingAddress.country":{required:true},
				"shippingAddress.zipcode":{required:true,number:true},
			},
			messages:{
				firstName:{required:'<span class="error">Field cannot be blank</span>'},
				lastName:{required:'<span class="error">Field cannot be blank</span>'},
				...
				"user.password":{required:'Field cannot be blank',minlength:'password cannot be smaller than 5',maxlength:'password cannot be larger than 10'},
				"billingAddress.apartmentnumber":{required:'Field cannot be blank'},
				"billingAddress.streetname":{required:'Field cannot be blank'},
				"billingAddress.city":{required:'Field cannot be blank'},
				"billingAddress.state":{required:'Field cannot be blank'},
				"billingAddress.country":{required:'Field cannot be blank'},
				"billingAddress.zipcode":{required:'Field cannot be blank',number:'This field only contains number'},
				"shippingAddress.apartmentnumber":{required:'Field cannot be blank'},
				"shippingAddress.streetname":{required:'Field cannot be blank'},
				"shippingAddress.city":{required:'Field cannot be blank'},
				"shippingAddress.state":{required:'Field cannot be blank'},
				"shippingAddress.country":{required:'Field cannot be blank'},
